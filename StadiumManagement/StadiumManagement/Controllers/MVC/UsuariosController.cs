...
using StadiumManagement.Classes;
        ...
        public ActionResult Create(UsuarioView view)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    if(view.Usuario.Trabalhador)
                    {
                        Utilidades.AddRoleToUser(view.Usuario.UserName, "Trabalhador");
                    }

                    if (view.Usuario.Chefe)
                    {
                        Utilidades.AddRoleToUser(view.Usuario.UserName, "Chefe");
                    }
